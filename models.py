...
class User(db.Model):
    ...
    favoriteGenres = db.Column(db.PickleType, nullable=True)  # Store list of genres
    createdAt = db.Column(db.DateTime, default=datetime.utcnow)

# 2️⃣ Followers Table (Many-to-Many Relationship)
...
# 6️⃣ Songs Table (Caching Spotify song metadata)
class Song(db.Model):
    __tablename__ = 'songs'
